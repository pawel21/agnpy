...
from .kernels_jit import isotropic_kernel_jit
from ..synchrotron import SynchrotronJit
...
__all__ = ["SynchrotronSelfComptonJit"]


class SynchrotronSelfComptonJit:
    ...
    def evaluate_sed_flux(
        ...
        **Note** arguments after *args are keyword-only arguments
        ...
        # integrate
        kernel = isotropic_kernel_jit(_gamma, _epsilon.value, _epsilon_s.value)
        integrand = (
